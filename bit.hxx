...
namespace bit {
   ...
   namespace detail {
    ...
    namespace mod {
        using bit::bit_size_of;
        using bit::half_word_bit_size_of;

        using namespace bit::detail;

        namespace detail {
            struct shift_left_fn : integer_adapter_base {
                using integer_adapter_base::operator();
                template<bool=0, 
                    no_const tp_integral1_t,
                    typename tp_integral2_t
                >
                requires(
                    integrals_of_matching_signedness<
                        std::remove_reference_t<tp_integral1_t>,
                        tp_integral2_t
                    >
                )
                [[maybe_unused]]
                auto constexpr operator()(
                    tp_integral1_t&      p_value1,
                    const tp_integral2_t p_value2
                )
                const noexcept
                -> tp_integral1_t& {
        ...
        namespace detail {
            struct align_by_weak_shift_fn : integer_adapter_base {
                ...
                [[maybe_unused]]
                auto constexpr operator()(
                    tp_integral1_t&      p_value,
                    const tp_integral2_t p_old_from_index,
                    const tp_integral3_t p_new_from_index
                ) const noexcept
                -> tp_integral1_t& {
                    return p_value = bit::align_by_weak_shift(
                        p_value,
                        p_old_from_index,
                        p_new_from_index
                    );
        ...
        namespace detail {
            struct align_by_strong_shift_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::align_by_strong_shift(
                        p_value,
                        p_old_from_index,
                        p_new_from_index
                    );
        ...
        namespace detail {
            struct enable_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::enable_in_range(
                        p_value,
                        p_from_index,
                        p_to_index
                    );
        ...
        namespace detail {
            struct disable_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::disable_in_range(
                        p_value,
                        p_from_index,
                        p_to_index
                    );
        ...
        namespace detail {
            struct set_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::set_in_range(
                        p_value,
                        p_from_index,
                        p_to_index,
                        p_state
        ...
        namespace detail {
            struct enable_from_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::enable_from(
                        p_value,
                        bit_size_of<tp_integral1_t> - 1
                    );
                }
        ...
        namespace detail {
            struct disable_from_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::disable_from(
                        p_value,
                        bit_size_of<tp_integral1_t> - 1
                    );
                }
        ...
        namespace detail {
            struct enable_from_right_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::enable_from_right(
                        p_value,
                        p_count
                    );
                }
        ...
        namespace detail {
            struct enable_from_left_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::enable_from_left(
                        p_value,
                        p_count
                    );
                }
        ...
        namespace detail {
            struct disable_from_right_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::disable_from_right(
                        p_value,
                        p_count
                    );
                }
        ...
        namespace detail {
            struct disable_from_left_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::disable_from_left(
                        p_value,
                        p_count
                    );
                }
        ...
        namespace detail {
            struct set_from_right_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::set_from_right(
                        p_value,
                        p_count,
                        p_state
                    );
        ...
        namespace detail {
            struct set_from_left_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::set_from_left(
                        p_value,
                        p_count,
                        p_state
                    );
        ...
        using bit::integers_to_mask;
        using bit::decimal_to_mask;
        
        namespace detail {
            struct enable_fn : integer_adapter_base {
                using integer_adapter_base::operator();
                template<bool=0, 
                    no_const tp_integral_t,
                    class... tp_integral_ts
                >
                requires(
                    integrals_of_matching_signedness<
                        std::remove_reference_t<tp_integral_t>,
                        tp_integral_ts...
                    >
                )
                [[maybe_unused]]
        ...
        namespace detail {
            struct extract_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::extract_in_range(
                        p_value,
                        p_from_index,
                        p_to_index
                    );
        ...
        namespace detail {
            struct extract_from_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::extract_from(
                        p_value,
                        bit_size_of<tp_integral1_t> - 1
                    );
                }
        ...
        namespace detail {
            struct extract_low_word_fn : integer_adapter_base {
                using integer_adapter_base::operator();
                template<bool=0, no_const tp_integral_t>
                requires(std::integral<std::remove_reference_t<tp_integral_t>>)
                [[maybe_unused]]
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::extract_low_word(p_value);
                }
            };
        }
        auto constexpr extract_low_word = detail::extract_low_word_fn{};
        ...
        namespace detail {
            struct extract_high_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::extract_high_word(p_value);
                }
            };
        }
        auto constexpr extract_high_word = detail::extract_high_word_fn{};
        ...
        namespace detail {
            struct enable_low_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::enable_low_word(p_value);
                }
            };
        }
        auto constexpr enable_low_word = detail::enable_low_word_fn{};
        ...
        namespace detail {
            struct disable_low_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::disable_low_word(p_value);
                }
            };
        }
        auto constexpr disable_low_word = detail::disable_low_word_fn{};
        ...
        namespace detail {
            struct enable_high_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::enable_high_word(p_value);
                }
            };
        }
        auto constexpr enable_high_word = detail::enable_high_word_fn{};
        ...
        namespace detail {
            struct disable_high_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::disable_high_word(p_value);
                }
            };
        }
        auto constexpr disable_high_word = detail::disable_high_word_fn{};

        using bit::low_word_mask;
        using bit::high_word_mask;
        ...
        namespace detail {
            struct copy_in_range_to_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::copy_in_range_to(
                        p_destination,
                        p_source,
                        p_from_index,
                        p_to_index,
        ...
        namespace detail {
            struct copy_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::copy_in_range(
                        p_destination,
                        p_source,
                        p_from_index,
                        p_to_index
        ...
        namespace detail {
            struct copy_from_to_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::copy_from_to(
                        p_destination,
                        p_source,
                        p_from_index,
                        p_output_index
        ...
        namespace detail {
            struct copy_from_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::copy_from(
                        p_destination,
                        p_source,
                        bit_size_of<tp_integral1_t> - 1
                    );
        ...
        namespace detail {
            struct move_in_range_to_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::move_in_range_to(
                        p_destination,
                        p_source,
                        p_from_index,
                        p_to_index,
        ...
        namespace detail {
            struct move_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::move_in_range(
                        p_destination,
                        p_source,
                        p_from_index,
                        p_to_index
        ...
        namespace detail {
            struct move_from_to_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::move_from_to(
                        p_destination,
                        p_source,
                        p_from_index,
                        p_output_index
        ...
        namespace detail {
            struct move_from_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::move_from(
                        p_destination,
                        p_source,
                        bit_size_of<tp_integral1_t> - 1
                    );
        ...
        namespace detail {
            struct swap_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::swap_in_range(
                        p_value1,
                        p_value2,
                        p_from_index,
                        p_to_index
        ...
        namespace detail {
            struct reverse_in_range_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::reverse_in_range(
                        p_value,
                        p_from_index,
                        p_to_index
                    );
        ...
        namespace detail {
            struct reverse_from_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::reverse_from(
                        p_value,
                        bit_size_of<tp_integral1_t> - 1
                    );
                }
        ...
        namespace detail {
            struct reverse_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::reverse(p_value);
                }
            };
        }
        auto constexpr reverse = detail::reverse_fn{};
        ...
        namespace detail {
            struct reverse_low_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::reverse_low_word(p_value);
                }
            };
        }
        auto constexpr reverse_low_word = detail::reverse_low_word_fn{};
        ...
        namespace detail {
            struct copy_low_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::copy_low_word(
                        p_destination,
                        p_source
                    );
                }
        ...
        namespace detail {
            struct copy_high_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::copy_high_word(
                        p_destination,
                        p_source
                    );
                }
        ...
        namespace detail {
            struct move_low_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::move_low_word(
                        p_destination,
                        p_source
                    );
                }
        ...
        namespace detail {
            struct move_high_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_destination = bit::move_high_word(
                        p_destination,
                        p_source
                    );
                }
        ...
        namespace detail {
            struct swap_low_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::swap_low_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct swap_high_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::swap_high_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct swap_half_word_fn : integer_adapter_base {
                ...
                auto constexpr operator()(tp_integral_t& p_value) const noexcept
                -> tp_integral_t& {
                    return p_value = bit::swap_half_word(p_value);
                }
            };
        }
        auto constexpr swap_half_word = detail::swap_half_word_fn{};
        ...
        namespace detail {
            struct or_low_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::or_low_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct or_high_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::or_high_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct and_low_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::and_low_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct and_high_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::and_high_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct xor_low_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::xor_low_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct xor_high_word_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value1 = bit::xor_high_word(
                        p_value1,
                        p_value2
                    );
                }
        ...
        namespace detail {
            struct assign_by_sequence_fn : integer_adapter_base {
                ...
                -> tp_integral1_t& {
                    return p_value = bit::assign_by_sequence(
                        p_value,
                        p_from_index,
                        p_indices...
                    );
